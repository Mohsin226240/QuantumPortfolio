  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 pointer-events-none perspective-1000">
        {/* Cube-ish Shape */}
        <motion.div
          className="absolute top-1/4 left-1/4 w-32 h-32 border-2 border-cyan-500/40 dark:border-cyan-500/30 bg-cyan-500/10 dark:bg-cyan-500/5 backdrop-blur-sm rounded-xl"
          animate={{ rotate: 360 }}
        ...
        {/* Sphere-ish Shape */}
        <motion.div
          className="absolute bottom-1/3 right-1/4 w-48 h-48 rounded-full border border-magenta-500/40 dark:border-magenta-500/30 bg-gradient-to-br from-magenta-500/20 dark:from-magenta-500/10 to-transparent backdrop-blur-sm"
        ...
        {/* Torus / Ring Shape */}
        <motion.div
          className="absolute top-1/3 right-1/3 w-64 h-64 rounded-full border-4 border-gray-400/50 dark:border-white/10"
          animate={{ rotateZ: 360 }}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          <span className="inline-block px-4 py-2 rounded-full bg-gray-100/80 dark:bg-white/5 border border-border-light dark:border-white/10 text-cyan-400 text-sm font-medium mb-8 backdrop-blur-md">
            Next Generation Digital Agency
          </span>

          <h1 className="text-6xl md:text-8xl font-bold tracking-tighter text-text-light dark:text-white mb-8 leading-tight">
            We Build <br />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 bg-white/10 border border-border-light dark:border-white/10 rounded-full text-text-light dark:text-white font-bold text-lg flex items-center gap-2 hover:bg-white/20 dark:hover:bg-white/10 backdrop-blur-md transition-colors"
            >
